...
app.post('/process-research', async (req, res) => {
  ...
  try {
    ...
    if (jobError || !job) {
      console.error(`[${job_id}] Job not found:`, jobError);
      return;
    }
...
Niche: ${job.niche || 'Not specified'}`;
    ...
    // Try to parse with Lovable AI (optional - if it fails, we still have raw research)
...
Return ONLY valid JSON, no other text.`;
        ...
        // Continue without parsed research - raw is still available
      }
    }
